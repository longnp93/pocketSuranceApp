...
demo = {
	...
	showNotification: function(from, align, iColor, sIcon, sMsg){
    	color = iColor || Math.floor((Math.random() * 4) + 1);

    	$.notify({
        	icon: sIcon || "ti-gift",
        	message: sMsg || "Welcome to <b>Paper Dashboard</b> - a beautiful freebie for every web developer."
